...
SETUP_PROPOSAL_CHAR_1 = 'a'
ENTER_LABOR_ESTIMATES_CHAR_1 = 'e'
PRICE_PROPOSAL_CHAR_1 = 'f'
SETUP_PROPOSAL_CHAR_2 = 'A'
ENTER_LABOR_ESTIMATES_CHAR_2 = 'E'
PRICE_PROPOSAL_CHAR_2 = 'F'

ENTER_PROPOSAL_NAME_CHAR_1 = 'b'
ENTER_PROPOSAL_FEE_CHAR_1 = 'c'
EXIT_PROPOSAL_SETUP_CHAR_1 = 'e'
ENTER_PROPOSAL_NAME_CHAR_2 = 'B'
ENTER_PROPOSAL_FEE_CHAR_2 = 'C'
EXIT_PROPOSAL_SETUP_CHAR_2 = 'E'
...
class ProposalGenerator(Actions):
    ...
    def prop_setup(self):
        ...
        self.write(random.choice(SETUP_PROPOSAL_CHAR_1 + SETUP_PROPOSAL_CHAR_2) + '\n')
    ...
    def return_to_main_menu(self):
        ...
        self.write(random.choice(EXIT_PROPOSAL_SETUP_CHAR_1 + EXIT_PROPOSAL_SETUP_CHAR_2) + '\n')
    ...
    def enter_title(self):
        ...
        self.read(delim=':', expect=':')
        #self.write(random.choice('bB') + '\n')
        self.write(random.choice(ENTER_PROPOSAL_NAME_CHAR_1 + ENTER_PROPOSAL_NAME_CHAR_2) + '\n')

        # actual input expected to be 100 bytes or less, do 105 to test bounds checking
        temp_str=''.join(random.choice('abcdefghijklmnop') for _ in range(105))
    ...
    def enter_profit(self):
        ...
        self.read(delim=':', expect=':')
        #self.write(random.choice('cC') + '\n')
        self.write(random.choice(ENTER_PROPOSAL_FEE_CHAR_1 + ENTER_PROPOSAL_FEE_CHAR_2) + '\n')
        ...
        while (1):
            ...
            self.profit = random.randint(0,1600)
    ...
    def fill_resources(self):
        ...
        if self.fill_performed==False:
            ...
            num_resources = random.randint(400, 650)
    ...
    def enter_data(self, count):
        ...
        self.read(delim=':', expect=':')
        #self.write(random.choice('dD') + '\n')
        self.write(random.choice(ENTER_LABOR_ESTIMATES_CHAR_1 + ENTER_LABOR_ESTIMATES_CHAR_2) + '\n')
        ...
        for x in range(0, count):
            ...
            eng_hours = random.randint(1, 10000)
    ...
    def price_proposal(self):
        ...
        self.write(random.choice(PRICE_PROPOSAL_CHAR_1 + PRICE_PROPOSAL_CHAR_2) + '\n')
